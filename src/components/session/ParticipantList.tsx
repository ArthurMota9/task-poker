  ...
  return (
    <div className="space-y-0.5">
      {list.map((participant) => {
        ...
        return (
          <div key={participant.id} className="flex items-center justify-between px-2 py-1 rounded-md">
            <div className="flex items-center gap-1.5 min-w-0">
              ...
              {participant.isHost && (
                <Badge variant="secondary" className="text-xs py-0 px-1 shrink-0">{t('host')}</Badge>
              )}
            </div>
